...
[ApiController] //บอกว่าการแสดงผลต่างๆในหน้านี้จะเป็น Json
[Route("api/[controller]")] // api/User  กำหนดเส้นทาง
public class UserController : ControllerBase
{
    //UserController จะทำงานภายใต้ ControllerBase โดยการสืบทอด
    // mock data for users
